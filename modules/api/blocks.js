 ...
 *
 * @param id - Block id.
 * @param {Blocks~blockCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Blocks~getBlocksCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Blocks~getHeightCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Blocks~getFeeCallback} cb - Callback handles response from Ebookcoin.
 */
