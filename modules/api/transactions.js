/*
	Ebookcoin transactions API calls
 */
 ...
 * @param {Transactions~getTransactionsCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Transactions~getTransaction} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Transactions~getUnconfirmedTransaction} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Transactions~getUnconfirmedTransactions} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Transactions~addTransactionsCallback} cb - Callback handles response from Ebookcoin.
 */
