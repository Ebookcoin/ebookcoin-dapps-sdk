 ...
 * @param {Sql~selectCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Sql~insertCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Sql~batchCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Sql~updateCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Sql~removeCallback} cb - Callback handles response from Ebookcoin.
 */
