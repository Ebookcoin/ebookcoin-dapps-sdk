 ...
 * @param {Delegates~getDelegateCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Delegates~getDelegatesCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 *
 * @param {Delegates~getFeeCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Delegates~getForgedByAccount} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Delegates~addDelegate} cb - Callback handles response from Ebookcoin.
 */
