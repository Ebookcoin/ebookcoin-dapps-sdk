 ...
 * @param {Contacts~getContactsCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Contacts~addContactCallback} cb - Callback handles response from Ebookcoin
 */
 ...
 * @param {Contacts~getFeeCallback} cb - Callback handles response from Ebookcoin.
 */
