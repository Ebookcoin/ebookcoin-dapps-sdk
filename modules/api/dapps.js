 ...
 * @param {Dapps~getGenesisCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Dapps~sendWithdrawal} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Dapps~setReadyCallback} cb - Callback handles response from Ebookcoin.
 */
