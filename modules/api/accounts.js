...
/**
 * Open account in Ebookcoin.
 *
 * @param secret - Secret of account.
 * @param {Accounts~openCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param {Accounts~balanceCallback} cb - Callback handle response from Ebookcoin.
 */
 ...
 * @param address - Address of account.
 * @param {Accounts~publicKeyCallback} cb - Callback handle response from Ebookcoin.
 */
 ...
 *
 * @param address - Address of account.
 * @param {Accounts~delegatesCallback} cb - Callback handle response from Ebookcoin.
 */
