...
/**
 * Send message to Ebookcoin.
 * @param topic - Topic of message.
 * @param message - Message.
 * @param {Transport~message} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param query - Query.
 * @param {Transport~getRandomPeerCallback} cb - Callback handles response from Ebookcoin.
 */
 ...
 * @param path - Path (part of url).
 * @param query - Query.
 * @param {Transport~getPeerCallback} cb - Callback handles response from Ebookcoin.
 */
